        ...
        <main>
          ...
          <section id="author" className="py-32 px-6 max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
              ...
              <div className="order-1 lg:order-2 relative reveal-section">
                <div className="absolute -inset-10 border-4 border-brand-gold/20 rounded-[4rem] rotate-3 blur-md opacity-50"></div>
                <div className="relative rounded-[4rem] overflow-hidden aspect-[4/5.5] shadow-[0_0_120px_rgba(0,0,0,1)] border-4 border-white/20 group">
                  ...
                  <div className="absolute bottom-12 left-12 right-12">
                    <div className="bg-white/10 backdrop-blur-3xl px-12 py-10 rounded-[3rem] shadow-2xl border-2 border-white/30">
                       <div className="flex items-center gap-5 mb-4">
                         <span className="material-symbols-outlined text-brand-gold text-4xl drop-shadow-lg">verified</span>
                         <p className="text-white font-black uppercase tracking-[0.4em] text-xs">Transmitting Frequency</p>
                       </div>
                       <p className="text-white font-regal text-3xl font-black italic">"Outstanding Program Impact Award"</p>
                    </div>
                  </div>
                </div>
              </div>
